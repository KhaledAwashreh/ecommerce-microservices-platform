 ...
 * This was the worst case cited in that issue: payment-service had no security
 * dependency and no filter at all, so direct network access to the pod allowed
 * processing, viewing, and refunding arbitrary payments.
 * <p>
