...
import com.kawashreh.ecommerce.payment_service.constants.JwtConstants;
 ...
 * Closes the worst-case in GH #17: previously this service had no security
 * dependency and no filter at all, so direct network access allowed processing,
 * viewing, and refunding arbitrary payments.
 */
@Component
